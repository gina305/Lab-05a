...
function multiply(a, b) { //eslint-disable-line
 //Calculate product
 let product = a * b; //Multiply numbers
...
//Assign variables for use in addition
let num1=sumArr[0];
let num2=sumArr[1];
let num3=sumArr[2];

//Calculate sum of numbers
let firstNum = sum(num1,num2)[0];
let totalSum = sum(firstNum,num3);
let splitSum = parseInt(totalSum[0]);

//Create the required string for sumArr[0]
let string1=`${num1},${num2},${num3} was passed in as an array of numbers, and ${splitSum} is their sum.`;

return [splitSum, string1];
